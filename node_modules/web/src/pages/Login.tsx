...
export const Login: React.FC = () => {
    ...
    return (
        <div style={{
            ...
            {/* Background Decor */}
            <div style={{ position: 'absolute', top: '-10%', right: '-5%', width: '40%', height: '40%', background: 'rgba(59, 130, 246, 0.05)', filter: 'blur(100px)', borderRadius: '50%' }}></div>
            <div style={{ position: 'absolute', bottom: '-10%', left: '-5%', width: '40%', height: '40%', background: 'rgba(45, 212, 191, 0.05)', filter: 'blur(100px)', borderRadius: '50%' }}></div>

            <div className="card glass-card" style={{ width: '100%', maxWidth: '440px', padding: '3rem', textAlign: 'center' }}>
                <div className="logo" style={{ justifyContent: 'center', marginBottom: '1rem' }}>
                    <Waves size={40} color="#3b82f6" />
                    Mekong AI
                </div>
